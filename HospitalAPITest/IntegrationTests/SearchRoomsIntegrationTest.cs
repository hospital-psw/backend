namespace HospitalAPITest.IntegrationTests
{
    ...
    public class SearchRoomsIntegrationTest : BaseIntegrationTest
    {
        ...
        {
            return new RoomsController(serviceScope.ServiceProvider.GetRequiredService<IRoomService>(), serviceScope.ServiceProvider.GetRequiredService<IEquipmentService>());
        }
        ...
        public void Get_searched_rooms()
        {
            ...
            var searchCriteria = new SearchCriteriaDto(3, 0, "003", "ordinacija", new DateTime(2022, 11, 10, 4, 0, 0), new DateTime(2022, 11, 10, 7, 0, 0), 0, 5);
