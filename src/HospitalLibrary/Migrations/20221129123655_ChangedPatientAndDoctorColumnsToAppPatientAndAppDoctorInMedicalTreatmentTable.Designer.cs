...
namespace HospitalLibrary.Migrations
{
    ...
    [Migration("20221129123655_ChangedPatientAndDoctorColumnsToAppPatientAndAppDoctorInMedicalTreatmentTable")]
    partial class ChangedPatientAndDoctorColumnsToAppPatientAndAppDoctorInMedicalTreatmentTable
    {
            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.Medicament.Allergies", b =>
                {
                    b.HasOne("HospitalLibrary.Core.Model.ApplicationUser.ApplicationPatient", null)
                        .WithMany("Allergies")
                        .HasForeignKey("ApplicationPatientId");
                });
